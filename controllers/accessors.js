import { getUserAccessorsFromBlockchain, grantAccessBlockchain, revokeAccessBlockchain } from "./blockchain.js";
...
export const getUserAccessors = async (req, res) => {
  try {
    let { userId } = req.body;
    ...
    /**get the accessors from the  blockchain */
    await getUserAccessorsFromBlockchain(req,res)
