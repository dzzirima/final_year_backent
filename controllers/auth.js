...
import { createUser, getAccessors, getAllUsersFromBlockChain } from "./blockchain.js";
...
export const register = async (req, res) => {
  ...
  try {
    // create a user to the blockchain
    await createUser(userId, req, res);
...
export const getAllUsers = async (req, res) => {
  try {
    ...
    await getAllUsersFromBlockChain(req,res)
  } catch (error) {
    return res.json({
      success: false,
      message: `${error.message}`,
